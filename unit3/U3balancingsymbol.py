...
# 2. Create Blueprint
balancingsymbol_bp = Blueprint(
    'balancingsymbol_bp', __name__
)
...
<body>
    ...
    <script>
        ...
        async function checkBalance() {
            ...
            // FIX: Relative fetch path is already correct
            ...
            // FIX: Clear the input box for better UX
            exprInput.value = "";
...
@balancingsymbol_bp.route('/check')
def check():
